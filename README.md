...
## **雑記**
---
情報科学科に入学してからの2年間は漫然とコンピュータサイエンスやプログラミングを学んでいましたが、

3年時に履修したCPU製作実験を経て、「CPUはハードウェア上でこういう風に動いているのか！」と腹落ちして以来、

組み込み分野やハードウェアアクセラレーションの分野に強い興味を持ちました。

私が特に興味を惹かれたのは、開発者が自由にデジタル回路を設計できるFPGAを用いたハードウェアプロダクトです。

ASIC設計よりも早く開発できて、特定のデータ処理に特化でき、製品提供後の再利用・変更が容易！

今後莫大な量の計算リソースが必要となる上に、製品にまつわる要求や要素技術が急速に変化する現代において、

FPGAは非常に重要な役割を果たすことになると確信しています。

---

というわけで、当学科の中でも組み込み分野に詳しい塩見研究室に在籍し、研究室の業務を手伝いながらFPGA開発の学習を進めていました。

そして、社会人向けの組み込み技術講座の運営を手伝ううちに気が付いたことがあります。

自分には組み込み開発の基礎的な知識が全く不足しているのです。

FPGAがきっかけで組み込み分野に入ったので当然といえば当然ですが、

これはマズいだろうということで、エンベデッドシステムスペシャリストの勉強を始めました。
